...
def encrypt(text,key):
    ...
    print("Initial add round key: ", end=' ')
    state_print(text)
    print()

    for i in range(1,11):
        print('Round ' + str(i) + " of encryption : ")
        sub_bytes(text)
        print("Sub bytes: ", end = " ")
        state_print(text)
        print()
...
def text_print(text):
    ...
    for i in range(16):
        lemon += chr(ascii_v[hex_v.index(text[i])])
...
def decrypt(text):
    ...
    for i in range(1, 11):
        print('Round ' + str(i) + ' of decryption: ')

        inv_sub_bytes(text)
        print('Inverse Sub Bytes: ', end='')
        state_print(text)
        print()

        inv_shift_rows(text)
        print('Inverse Shift Rows: ', end='')
        state_print(text)
        print()
